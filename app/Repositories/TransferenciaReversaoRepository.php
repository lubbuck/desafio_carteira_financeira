...
use App\Models\TransferenciaReversao;

class TransferenciaReversaoRepository implements TransferenciaReversaoRepositoryInterface
{
    protected $model;

    public function __construct(TransferenciaReversao $model)
    {
        $this->model = $model;
    }
