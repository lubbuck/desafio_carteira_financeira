...
class SolicitacaoTransferenciaReversaoRepository implements SolicitacaoTransferenciaReversaoRepositoryInterface
{
    protected $model;

    public function __construct(SolicitacaoTransferenciaReversao $model)
    {
        $this->model = $model;
    }
