...
use App\Models\DepositoReversao;

class DepositoReversaoRepository implements DepositoReversaoRepositoryInterface
{
    protected $model;

    public function __construct(DepositoReversao $model)
    {
        $this->model = $model;
    }
